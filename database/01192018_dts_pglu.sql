...
insert  into `tbl_document`(`id`,`recieve_date`,`end_date`,`barcode`,`transaction_type`,`document_type`,`source_type`,`office_code`,`delivery_method`,`source_name`,`gender`,`contact_no`,`email_address`,`subject_matter`,`prerequisite`,`access_code`,`total_office_time`,`total_transit_time`,`transaction_end_date`,`transaction_status`,`username`,`to_ocm`,`status`) values (1,'2018-01-19 16:41:11','2018-01-26 16:41:11','00001','SIMP','COM','INT','OPG','3','GOVERNOR','Male','','','SM','','PBUGLG',6481.05,0.35,'0000-00-00','','rec','0','1');
...
insert  into `tbl_document_transaction`(`trans_id`,`barcode`,`sequence`,`transit_date_time`,`office_code`,`person`,`recieve_date_time`,`recieve_action`,`route_office_code`,`release_date_time`,`release_action`,`remarks`,`current_action`,`office_time`,`transit_time`,`status`) values ('201801191641209278240','00001',1,'2018-01-19 16:41:41','REC','rec','2018-01-19 16:41:11','New Document Trail','ISO','2018-01-19 16:41:20','-','-','',0.15,0.35,'0'),('20180119164141818089','00001',2,NULL,'ISO','test','2018-01-19 16:41:41','RA','OPG','2018-02-06 16:44:05','RA','REMARKS','REL',6480.9,0,'1');
