...
<body>
	...
	if($_REQUEST['report']=="thismonth"){
		...
		$qry_com_out_simp = mysqli_fetch_assoc($qry_com_out_simp);
	...
	<div class="new-container-dashboard">
		...
		<div style="float: left; padding-right: 10px; width: 200px;">
			...
			Yants
			May 7, 2019
			To identify list of docu your office has been done
			 -->
			<div class="head-dash-lgreen" style="height:70px;">RECEIVED BY YOUR OFFICE</div>
			<div class="sub-head-dash-lgreen">LIST</div>
			<div class="title-dash">NO. OF DOCUMENTS</div>
			...
			<br>
		<div class="head-dash-lgreen" style="height:70px;">COMPLETED TRANSACTIONS</div>
			<div class="sub-head-dash-lgreen">LIST</div>
			<div class="title-dash">NO. OF DOCUMENTS</div>
	...
	<div style="display: inline;" id="simple">
		<div class="new-container-dashboard">
			...
			<div style="float: left; padding-right: 10px; width: 200px;">
				<div class="title-dash">COMMUNICATION IN</div>
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_in_simp['result'],2).' days';
					?>
				</div>
			</div>

			<div style="float: left; padding-right: 10px; width: 200px;">
				<div class="title-dash">COMMUNICATION OUT</div>
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_out_simp['result'],2).' days';
					?>
				</div>
			</div>
	...
	<div style="display: none" id="complex">
		<div class="new-container-dashboard">
			...
			<div style="float: left; padding-right: 10px; width: 200px;">
				...
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_in_comp['result'],2).' days';
					?>
				</div>
			</div>
			...
			<div style="float: left; padding-right: 10px; width: 200px;">
				...
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_out_comp['result'],2).' days';
					?>
				</div>
			</div>
			<!-- END OF NEW CODE
	...
	<div style="display: none;" id="high">
		<div class="new-container-dashboard">
			...
			<div style="float: left; padding-right: 10px; width: 200px;">
				...
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_in_high['result'],2).' days';
					?>
				</div>
			</div>
			...
			<div style="float: left; padding-right: 10px; width: 200px;">
				...
				<div class="figure-dash">
					<?php
						echo number_format($qry_com_out_high['result'],2).' days';
					?>
				</div>
			</div>
	...
	<?php
		...
		//DASHBOARD QUERY
		//WAHID - 4/29/2019
		$qry_com_in_simp = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COI' and transaction_type='SIMP'");
		$qry_com_in_simp = mysqli_fetch_assoc($qry_com_in_simp);

		$qry_com_out_simp = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COO' and transaction_type='SIMP'");
		$qry_com_out_simp = mysqli_fetch_assoc($qry_com_out_simp);
		...
		//DASHBOARD QUERY
		//WAHID - 4/29/2019
		$qry_com_in_comp = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COI' and transaction_type='COMP'");
		$qry_com_in_comp = mysqli_fetch_assoc($qry_com_in_comp);

		$qry_com_out_comp = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COO' and transaction_type='COMP'");
		$qry_com_out_comp = mysqli_fetch_assoc($qry_com_out_comp);
		...
		//DASHBOARD QUERY
		//WAHID - 4/29/2019
		$qry_com_in_high = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COI' and transaction_type='HIGH'");
		$qry_com_in_high = mysqli_fetch_assoc($qry_com_in_high);

		$qry_com_out_high = mysqli_query($connection,"select avg(timestampdiff(day,recieve_date,transaction_end_date))result from tbl_document where status!='0' and recieve_date like '$date_like%' and transaction_status!='' and document_type='COO' and transaction_type='HIGH'");
		$qry_com_out_high = mysqli_fetch_assoc($qry_com_out_high);
