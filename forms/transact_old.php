		...
		<div class="transact-result">
			...
			if(isset($_REQUEST['search'])){
				...
				?>
					...
					<div class="form-group form-space">
						<input type="text" class="form-control" name="recieveaction" id="recieveaction" placeholder="Receive Action" required="required">
					</div>
					<div class="form-group form-space">
...
if(isset($_REQUEST['releasedocument'])){
	...
	//update 
	mysqli_query($connection,"update tbl_document_transaction set route_office_code='$_REQUEST[routeoffice]', release_date_time='$wh', release_action='$ra', remarks='$rr', current_action='REL', office_time='$office_time' where barcode='$_REQUEST[releasebarcode]' and office_code='$access[office_code]' and current_action='REC' and status='1'");
